...
- Infinite jumping bug from player and canvas height determinant misappropriation.
...
todo: canvas resizing. game states.
...
Efficient Context Handling: Retrieve and store the canvas context once, and reuse it throughout the game.
